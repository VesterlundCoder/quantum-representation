...
\bibitem{ref5} S.~Das et al. ``A protocol for benchmarking quantum computer performance.'' QED-C, 2023.

\bibitem{ref6} [Placeholder---cite specific Qiskit vs.\ Cirq comparison paper.]

\bibitem{ref7} [Placeholder---cite specific PyTKET vs.\ Qiskit comparison paper.]

\bibitem{ref8} [Placeholder---cite Qiskit transpiler optimization / Pareto paper.]

\bibitem{ref9} [Placeholder---cite PyTKET depth-fidelity trade-off paper.]

\bibitem{ref10} [Placeholder---cite classical compiler autotuning literature, e.g., ATLAS, FFTW autotuning.]

\bibitem{ref11} [Placeholder---cite ML-guided quantum compilation paper.]
